...
//        Log.v(TAG,"getHistoricData");
        ...
        new AsyncTask<Void, Void, Void>()
        {
            ...
            protected Void doInBackground(Void... params)
            {
                try {
                    ...
                    stockData = new StockData(companyName, exchangeName, firstTrade, lastTrade, currency, previousClosePrice, stockSymbols);
            ...
            protected void onPostExecute(Void aVoid)
            {
                if (historicalDataCallback != null) {
                    ...
                    if (status == STATUS_OK) {
                        historicalDataCallback.onSuccess(stockData);
                    } else {
    ...
    {
        void onSuccess(StockData stockMeta);
